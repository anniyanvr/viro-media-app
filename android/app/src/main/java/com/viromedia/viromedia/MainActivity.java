...
public class MainActivity extends AppCompatActivity {
    ...
    private void setupSceneListView() {
        ...
        mSceneListTitles = new String[]{getString(R.string.ar_sample_title), getString(R.string.photo_tour_title),
                getString(R.string.media_player_title),
                getString(R.string.human_heart_title)};
        mSceneListSubTitles = new String[]{getString(R.string.ar_sample_subtitle), getString(R.string.photo_tour_subtitle),
                getString(R.string.media_player_subtitle),
                getString(R.string.human_heart_subtitle)};
        mSceneListBackgroundImages = new int[]{R.drawable.nativeapp_card_ar, R.drawable.card_360phototour,
                R.drawable.card_mediaplayer,
                R.drawable.card_humanheart};
        mSceneNames = new String[]{"AR Sample", "360 Photo Tour", "Viro Media Player", "Inside the Human Body"};
