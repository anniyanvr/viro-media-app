...
var PortalElement = React.createClass({
    propTypes: {
        jumpToRoom: PropTypes.string,
        showDayImage:PropTypes.bool,
        roomTitleText:PropTypes.string,
        roomTitleLength:PropTypes.number,
        iconOffset:PropTypes.number,
        backPortal:PropTypes.bool,
        onClick:PropTypes.func,
    },
    render:function(){
        var photoSceneText = this.props.roomTitleText;
        var textOffset = 0.55;
        ...
        return(
            <ViroNode {...this.props} transformBehaviors={["billboard"]} onClick={this._onCardTap} >
                ...
                <ViroImage
                          ...
                          width={this.props.roomTitleLength*2.5}
                          height={1}
    ...
    _onCardTap(){
        ...
        if (this.props.onClick){
            this.props.onClick(this.props.jumpToRoom, this.props.showDayImage);
        }
    },
});
