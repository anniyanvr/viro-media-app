 ...
 */
var videos = [
  require('./res/MediaDemo360_1.mp4'),
  require('./res/MediaDemo360_2.mp4')
];
...
var Viro360Theatre = React.createClass({
  ...
  _launchTheatreScene(){
    this.props.sceneNavigator.jump("ViroTheatre", {scene:require('./ViroTheatre'), passProps:{displayHomeButton:this.props.displayHomeButton}});
  },
  _togglePauseVideo() {
    this.setState({
